...
UPDATE `creature_template` SET `minlevel` = @maxLevel + 3, `maxlevel` = @maxLevel + 3 WHERE `entry` = 3057;  -- Cairne Bloodhoof <High Chieftain>
UPDATE `creature_template` SET `minlevel` = @maxLevel, `maxlevel` = @maxLevel WHERE `entry` = 14440; -- Hunter Sagewind
UPDATE `creature_template` SET `minlevel` = @maxLevel, `maxlevel` = @maxLevel WHERE `entry` = 14441; -- Hunter Ragetotem
UPDATE `creature_template` SET `minlevel` = @maxLevel, `maxlevel` = @maxLevel, `rank` = 0      WHERE `entry` = 3083; -- Honor Guard
UPDATE `creature_template` SET `minlevel` = @maxLevel - 5, `maxlevel` = @maxLevel - 5, `faction` = 105 WHERE `entry` = 3084; -- Bluffwatcher
