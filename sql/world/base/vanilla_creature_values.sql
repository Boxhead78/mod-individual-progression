...
/*  Ratchet Bruiser  */
UPDATE `creature_template` SET `minlevel` = @maxLevel, `maxlevel` = @maxLevel, `DamageModifier` = 2.0 WHERE `entry`=3502;
...
/*  Booty Bay Bruiser  */
UPDATE `creature_template` SET `minlevel` = @maxLevel, `maxlevel` = @maxLevel WHERE `entry`=4624;
...
/*  Gadgetzan Bruiser  */
UPDATE `creature_template` SET `minlevel` = @maxLevel, `maxlevel` = @maxLevel WHERE `entry`=9460;
...
/*  Everlook Bruiser  */
UPDATE `creature_template` SET `minlevel` = @maxLevel, `maxlevel` = @maxLevel, `DamageModifier` = 2.0 WHERE `entry`=11190;
